...
/// FITIN by LARC — Home.
///
/// Layout order (per brand spec):
/// 1. Brand header
/// 2. Primary feature: "WHAT DO I HAVE?" with "Start Cooking" CTA
/// 3. Secondary: "Search Recipes"
/// 4. Recommended Recipes (live backend preview)
/// 5. Nutrition Today
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  late final Future<List<RecipeSummary>> _recommended;
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            // --- Primary feature: WHAT DO I HAVE? ---
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  LarcPrimaryButton(
                    label: isAr ? 'ابدأ الطبخ' : 'Start Cooking',
            ...
            // --- Secondary: Search Recipes ---
            LarcSecondaryButton(
              label: isAr ? 'ابحث عن وصفات' : 'Search Recipes',
              icon: Icons.search,
              onPressed: () => Navigator.push(
                context,
            ...
            // --- Recommended Recipes ---
            LarcSectionHeader(
              eyebrow: isAr ? 'مقترحة' : 'RECOMMENDED',
              ...
              child: FutureBuilder<List<RecipeSummary>>(
                ...
                builder: (_, snap) {
                  ...
                  if (items.isEmpty) {
                    return Center(
                      child: Text(
                        isAr ? 'لا توجد وصفات بعد' : 'No recipes yet',
            ...
            // --- Nutrition Today ---
            LarcSectionHeader(
              eyebrow: isAr ? 'اليوم' : 'TODAY',
              title: isAr ? 'التغذية اليوم' : 'Nutrition Today',
            ),
            const SizedBox(height: 14),
            LarcCard(
              onTap: () => Navigator.push(
