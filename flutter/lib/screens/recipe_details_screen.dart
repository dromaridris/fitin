...
/// Recipe Details — fetches the real recipe (name, description,
/// ingredients) from GET /recipes/{id}, shows any missing ingredients
/// carried over from the "What Do I Have?" match, and links through to
...
class _RecipeDetailsScreenState extends State<RecipeDetailsScreen> {
  ...
  late final Future<RecipeDetail> _future;

  @override
  void initState() {
    super.initState();
    _future = _service.getDetail(widget.recipeId);
  }
        ...
        body: FutureBuilder<RecipeDetail>(
          ...
          builder: (_, snap) {
            ...
            return ListView(
              ...
              children: [
                Text(
                  recipe.title(s.languageCode),
                  style: Theme.of(context).textTheme.displayMedium,
                ),
                const SizedBox(height: 6),
                Text(
                  '${recipe.cuisine} • ${recipe.servings} '
                  '${s.isArabic ? "حصص" : "servings"} • '
                  '${recipe.prepMinutes + recipe.cookMinutes} '
                  '${s.isArabic ? "دقيقة" : "min"}',
                  style: Theme.of(context).textTheme.bodySmall,
                ),
                if (recipe.description(s.languageCode).isNotEmpty) ...[
                  const SizedBox(height: 16),
                  Text(
                    recipe.description(s.languageCode),
                ...
                Text(
                  s.isArabic ? 'المكونات' : 'Ingredients',
                  ...
                  onPressed: () => Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) => NutritionScreen(
                        ...
                        initialServings: widget.initialServings > 0
