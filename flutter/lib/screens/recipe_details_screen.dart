      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            Text(
              '${recipe.cuisine} • ${recipe.servings} ${s.isArabic ? "حصص" : "servings"} • ${recipe.prepMinutes + recipe.cookMinutes} ${s.isArabic ? "دقيقة" : "min"}',
            ...
            if (widget.fallbackMissing.isNotEmpty) ...[
              ...
              LarcCard(
                child: Column(
                  ...
                  children: [
                    Text(
                      s.isArabic ? 'المكونات الناقصة' : 'Missing Ingredients',
            ...
            const SizedBox(height: 24),
            LarcPrimaryButton(
              label: s.isArabic ? 'الكميات والسعرات' : 'Quantities & Nutrition',
